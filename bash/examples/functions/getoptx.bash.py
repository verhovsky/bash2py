...
{ 
    ...
    os.system('local optlist="" + $ + "{1#;}"')
    
    OPTIND || OPTIND=1
    
    OPTIND < $#  || os.system('return 1')
    ...
    if ("" + sys.argv[1] + "" != "-"  && "" + sys.argv[1] + "" != "" + $ + "{1#-}"  ):
        ...
        if ("" + sys.argv[1] + "" != "--"  ):
            ...
            for opt in [${optlist#;}]:
                ...
                os.system('unset OPTARG')
                
                os.system('local opttype="" + $ + "{opt##*[^;:.]}"')
                ...
                if (${#OPTOPT} > 1  ):
                    # long-named option
                        ...
                        if ( o == '"--$OPTOPT"'):
                            ...
                            if (-z "" + OPTARG + ""  ):
                                ...
                                OPTERR && print("" + sys.argv[0] + ": error: " + OPTOPT + " must have an argument")1>&2
                            ...
                            # skip option's argument
                            
                            os.system('return 0')
                        elif (o == '"--$OPTOPT="*'):
                            if ("" + opttype + "" == ";"  ):
                                # error: must not have arguments
                                
                                OPTERR && print("" + sys.argv[0] + ": error: " + OPTOPT + " must not have arguments")1>&2
                    ...
                    # short-named option
                        ...
                        if ( "" + o + "" == '"-$OPTOPT"'):
                            os.system('unset OPTOFS')
                            
                            "" + opttype + "" != ":"  && os.system('return 0')
                            
                            OPTARG="" + sys.argv[2] + ""
                            
                            if (-z "" + OPTARG + ""  ):
                                print("" + sys.argv[0] + ": error: -" + OPTOPT + " must have an argument")1>&2
                            ...
                            if (opttype == ";"  ):
                                # an option with no argument is in a chain of options
            ...
            print("" + sys.argv[0] + ": error: invalid option: " + o + "")
...
{ 
    ...
    while (-n "" + l + "" ):
        ...
        # append the first character of $l to $r
        
        l="" + $ + "{l#?}"
        
        # cut the first charecter from $l
        ...
        if (-n "" + $ + "{l%%[^:.;]*}"  ):
            ...
            # cut the special character from l
...
def getopt () 
{ 
    os.system('local optlist= os.popen('optlistex "" + sys.argv[1] + ""').read() ')
    
    os.system('shift')
    
    os.system('getoptex "" + optlist + "" "" + $ + "@"')
